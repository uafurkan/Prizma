...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const title = 'PRIZMA | The Universal File Converter';
  const description = 'Instantly convert files securely in your browser.';
          ...
          <footer className="border-t border-border bg-surface py-8 text-center">
            <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-sm text-muted">
                &copy; {new Date().getFullYear()} PRIZMA. {dict.common.allRightsReserved}
              </p>
